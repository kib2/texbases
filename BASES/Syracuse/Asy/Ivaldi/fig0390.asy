...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="line" signature="tangent(circle,point)"/></asyxml>*/
draw(tangent(c1,inter[0]), grey);
draw(tangent(c2,inter[0]), grey);

/*<asyxml><view file="modules/geometry_dev.asy.html" type="line" signature="tangent(circle,abscissa)"/></asyxml>*/
