...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="point" signature="angpoint(explicit parabola,real)"/></asyxml>*/
dot("angpoint(p, 180)",angpoint(p,180),SE+E);

/*<asyxml><view file="modules/geometry_dev.asy.html" type="point" signature="point(parabola,abscissa)"/></asyxml>*/
