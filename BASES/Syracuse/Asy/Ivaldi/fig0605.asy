...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="point" signature="point(explicit hyperbola,explicit real)"/></asyxml>*/
...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="real[]" signature="bangles(picture,hyperbola)"/></asyxml>*/
real[][] bg=bangles(h);
