...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="arc" signature="arc(ellipse,point,point,bool)"/></asyxml>*/
draw(arc(c,J[0],K[0]),1mm+0.8yellow);
draw(arc(c,K[0],J[1]),1mm+0.8red);
/*<asyxml><view file="modules/geometry_dev.asy.html" type="arc" signature="arc(ellipse,abscissa,abscissa,bool)"/></asyxml>*/
