...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="void" signature="dot(picture,Label,explicit point,align,string,pen)"/></asyxml>*/
...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="abscissa" signature="angabscissa(parabola,point)"/></asyxml>*/
...
// p=t*p;
// /*<asyxml><view file="modules/geometry_dev.asy.html" type="abscissa" signature="curabscissa(parabola,point)"/></asyxml>*/
...
// p=t*p;
// /*<asyxml><view file="modules/geometry_dev.asy.html" type="abscissa" signature="nodabscissa(parabola,point)"/></asyxml>*/
