...
real R=2;
/*<asyxml><view file="modules/geometry_dev.asy.html" type="" signature="struct circle"/></asyxml>*/
circle C=circle(A,R);
draw(C,1.5mm+red);
...
// the 'defaultcoordsys'
/*<asyxml><view file="modules/geometry_dev.asy.html" type="path" signature="*(coordsys,path)"/></asyxml>*/
