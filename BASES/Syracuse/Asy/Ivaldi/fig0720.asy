...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="abscissa" signature="angabscissa(arc,point)"/></asyxml>*/
x=angabscissa(c,M).x;
...
p=t*p;
/*<asyxml><view file="modules/geometry_dev.asy.html" type="abscissa" signature="curabscissa(arc,point)"/></asyxml>*/
x=curabscissa(c,M).x;
...
p=t*p;
/*<asyxml><view file="modules/geometry_dev.asy.html" type="abscissa" signature="nodabscissa(arc,point)"/></asyxml>*/
x=nodabscissa(c,M).x;
...
p=t*p;
/*<asyxml><view file="modules/geometry_dev.asy.html" type="abscissa" signature="relabscissa(arc,point)"/></asyxml>*/
x=relabscissa(c,M).x;
