...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="point" signature="point(coordsys,pair)"/></asyxml>*/
dot("",point(R,m),red); // Same as 'dot("",m,red);'
dot("",point(Rp,m),blue);

point M=m;
/*<asyxml><view file="modules/geometry_dev.asy.html" type="point" signature="point(coordsys,explicit point)"/></asyxml>*/
...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="pair" signature="/(pair,coordsys)"/></asyxml>*/
dot("$P'$",point(Rp,p/Rp),2S,3mm+blue); // Necessary for 'pair'
dot("$P'$",point(Rp,P/Rp),2N,3mm+blue); // but works with 'point' by casting.

/*<asyxml><view file="modules/geometry_dev.asy.html" type="point" signature="changecoordsys(coordsys,point)"/></asyxml>*/
