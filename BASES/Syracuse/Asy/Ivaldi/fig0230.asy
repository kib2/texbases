...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="line" signature="complementary(explicit line)"/></asyxml>*/
draw("Complementary of $(AB]$", complementary(l2), dotted+roundcap);

point p=intersectionpoint(l1,l2);

/*<asyxml><view file="modules/geometry_dev.asy.html" type="bool" signature="defined(pair)"/></asyxml>*/
