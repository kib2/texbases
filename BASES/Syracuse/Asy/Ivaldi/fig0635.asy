...
conic co[];
co[0]=circle((0,0),1);
/*<asyxml><view file="modules/geometry_dev.asy.html" type="void" signature="draw(picture,Label,explicit conic,align,pen,arrowbar,arrowbar,margin,Label,marker)"/></asyxml>*/
draw(co[0]);
...
for (int i=0; i < 4; ++i) {
  ...
  for (int j=i+1; j < 4; ++j)
    /*<asyxml><view file="modules/geometry_dev.asy.html" type="point[]" signature="intersectionpoints(conic,conic)"/></asyxml>*/
