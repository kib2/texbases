...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="transform" signature="scale(real,point,point,point,point,bool)"/></asyxml>*/
transform t=scale(2,A,B,A,C);
/*<asyxml><view file="modules/geometry_dev.asy.html" type="transform" signature="projection(point,point,point,point,bool)"/></asyxml>*/
