...
dot(point(p,x));
/*<asyxml><view file="modules/geometry_dev.asy.html" type="line" signature="tangent(parabola,abscissa)"/></asyxml>*/
draw(tangent(p,x), 0.8*red);

point[] P=intersectionpoints(p,pp);
dot(P);

/*<asyxml><view file="modules/geometry_dev.asy.html" type="line[]" signature="tangents(parabola,point)"/></asyxml>*/
