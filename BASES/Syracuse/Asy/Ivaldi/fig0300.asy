...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="ellipse" signature="*(transform,ellipse)"/></asyxml>*/
draw(scale(0.5)*el,red,Arrow);

draw(scale(0.5,A)*el,2mm+0.8*blue);

/*<asyxml><view file="modules/geometry_dev.asy.html" type="ellipse" signature="/(ellipse,real)"/></asyxml>*/
