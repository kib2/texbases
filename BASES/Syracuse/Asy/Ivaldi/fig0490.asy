...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="point" signature="relpoint(explicit ellipse,real)"/></asyxml>*/
dot("relpoint(el, 0)",relpoint(el,0),E);

/*<asyxml><view file="modules/geometry_dev.asy.html" type="point" signature="point(ellipse,abscissa)"/></asyxml>*/
