...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="line[]" signature="tangents(ellipse,point)"/></asyxml>*/
draw(tangents(el1,inter[0]), grey);
draw(tangents(el2,inter[0]), grey);

/*<asyxml><view file="modules/geometry_dev.asy.html" type="line" signature="tangent(ellipse,abscissa)"/></asyxml>*/
