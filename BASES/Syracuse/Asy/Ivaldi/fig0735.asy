...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="arc" signature="arc(explicit arc,point,point)"/></asyxml>*/
draw(arc(c,J[0],K[0]),2mm+0.8yellow);
draw(arc(c,K[0],J[1]),2mm+0.8red);
/*<asyxml><view file="modules/geometry_dev.asy.html" type="arc" signature="arc(explicit arc,abscissa,abscissa)"/></asyxml>*/
