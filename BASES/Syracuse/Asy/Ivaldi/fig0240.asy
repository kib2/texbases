...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="" signature="struct segment"/></asyxml>*/
...
/*<asyxml><view file="modules/geometry_dev.asy.html" type="line[]" signature="complementary(explicit segment)"/></asyxml>*/
line[] cs1=complementary(s1);

/*<asyxml><view file="modules/geometry_dev.asy.html" type="void" signature="draw(picture,Label[],line[],align,pen,arrowbar,Label,marker)"/></asyxml>*/
